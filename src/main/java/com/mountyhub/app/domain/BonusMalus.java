...
public class BonusMalus implements Serializable {
    ...
    @NotNull
    @Column(name = "real_effect", nullable = false)
    ...
    public BonusMalusType getType() {
        return type;
    }

    public void setType(BonusMalusType bonusMalusType) {
        this.type = bonusMalusType;
    }
